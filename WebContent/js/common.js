					...
					function() {
						if ($(window).scrollTop() > 150) {
							$("#js-scrolltop")
									.css(
											"left",
											document.body.clientWidth > 1366 ? (document.body.clientWidth - (document.body.clientWidth - 1200) / 2)
													: 1366 - (1366 - 1200) / 2);
			...
			.ajax({
				...
				success : function(data) {
					...
					if (jsonObj.success) {
						$("#js-checkLogin ul")
								.append(
										"<li><a class='editPreview' id='js-editPreview' href='javascript:void(0);' onclick='editPreview()'>"
												+ jsonObj.name + "</a></li>");
					} else {
						$("#js-checkLogin ul")
								.append(
